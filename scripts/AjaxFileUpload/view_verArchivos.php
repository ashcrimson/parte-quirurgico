...
<head>
	<title>Codigo de verArchivos.php</title>
...
<body>
	<h4>verArchivos.php</h4>
	<div style="background: #EFE; padding: 5px; border: 1px solid #8A8;">

	<?php
		highlight_file('verArchivos.php');
	?>
	</div>
</body>
